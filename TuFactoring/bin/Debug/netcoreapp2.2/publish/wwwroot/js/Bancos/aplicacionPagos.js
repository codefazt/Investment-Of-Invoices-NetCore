new Vue({
    ...
    created: function () {
        ...
        if (dataOverdue.length > 0 && dataOverdue[0].errors == notAuthorized || dataReconciled.length > 0 && dataReconciled[0].errors == notAuthorized) {
        ...
        try {
            ...
            document.getElementById("appAplicacionPagosBanco").removeChild(document.getElementById('jsonOverdue'))
            document.getElementById("appAplicacionPagosBanco").removeChild(document.getElementById('jsonReconciled'))
