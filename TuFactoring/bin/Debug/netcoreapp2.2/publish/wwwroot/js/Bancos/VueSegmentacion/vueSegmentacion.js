    ...
    methods: {
                        ...
                        data.data.prospecto.list.map(data => {
                            ...
                            if (data.executives != null) {
                                for (let i = 0; i < this.listaEjecutivos.length; i++) {
                                    if (data.executives[0].id == this.listaEjecutivos[i].id) EjecutivoCuenta = this.listaEjecutivos[i].name;
                                }
                            } else EjecutivoCuenta = null;
        ...
        async enviarDatos(segmentar) {
            ...
            if (data.data != "Error") {
                ...
                //setTimeout(function () { window.location.pathname = "/" + lenguage + "/Confirmant/Segmentacion"; }, 1300);
