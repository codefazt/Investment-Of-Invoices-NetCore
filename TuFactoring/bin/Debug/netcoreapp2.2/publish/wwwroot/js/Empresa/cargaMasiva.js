new Vue({
    ...
    data: {
        ...
        headers1: [
            ...
            {
                text: i18n.t("headers.valorNeto"), value: 'original_amount', align: "center"
            },
            {
    ...
    methods: {
                ...
                axios.post('?handler=guardar', this.facturas ,
                    ...
                    .then((respond) => {
                        ...
                        if (status == data.length) {
                            //toastr.success(i18n.t("mensajesModal.cargaFacturaMasiva"))
                            toastr.success(i18n.t("mensajesModal.estimadoUsuario") + "<br><br>" + i18n.t("mensajesModal.cargaFacturaMasiva"))
                        }
                    
                        if (status != data.length) {
                            //toastr.warning(i18n.tc("mensajesModal.problemasRespuesta", 2, {0: "registro de facturas"}))
                            toastr.warning(i18n.tc("mensajesModal.estimadoUsuario") + "<br><br>" + i18n.tc("mensajesModal.incovenientesFacturas"))
                        } 
        ...
        cargarData: function (e) {
            ...
            if (contenido == '') {
                ...
                if (!rE.test(contenido)) {
                    $("#facturaInputFile").val("")
                    //toastr.warning(i18n.t("mensajesModal.archivoInvalido"))
        ...
        validarFactura: function (data) {
            ...
            if (moment(data.expiration_date, "YYYY-MM-DD").diff(ahora.format("YYYY-MM-DD"), "days") <= 4) {
                console.log(moment(data.issued_date, "YYYY-MM-DD").diff(moment(data.expiration_date, "YYYY-MM-DD"), "days"))
        ...
        agregarFactura: function () {
            ...
            if (!this.encuentraErrorFactura()) {
                ...
                this.enviarFactura({
                    ...
                    //invoice_type_id: this.nuevo.tipoFactura,
        ...
        encuentraErrorFactura: function () {
            ...
            /*if (this.nuevo.tipoFactura == 0) {
                this.message = "tipoFactura"
                return true;
            }*/
