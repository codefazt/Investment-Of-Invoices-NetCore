new Vue({
    ...
    data: {
        ...
        headers1: [
            ...
            { text: i18n.t("headers.cliente"), value: "supplier.name", align: "center" },
    ...
    created: function () {
        ...
        document.getElementById("appEdicionFacturas").removeAttribute("hidden")
    ...
    methods: {
        async llenarFacturas(indice) {
            ...
            await axios.post('?handler=invoices', { pagination: { take: take, skip: this.totalFacturas[indice] }, filter: this.filter[indice] },
                ...
                .then((respond) => {
                    ...
                    this.facturasFiltradas = this.factur
        ...
        async llenarClientes() {
            ...
            await axios.post('EdicionFacturas?handler=clientes', {},
                {
                    headers: {
                        "RequestVerificationToken": $('input:hidden[name="__RequestVerificationToken"]').val()
                    }
        ...
        //
        validateStatus(item) {
            if (item.state == "draft" || item.state == "posted" || item.state == "revised") {
                return true
            }
        ...
        editFactura: async function (index) {
            ...
            this.nuevo.cliente.id = this.factura[index].debtor.id;
