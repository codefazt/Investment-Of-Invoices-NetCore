var app = new Vue({
    ...
    data: {
        ...
        headerConsulta: [
            ...
            { text: i18n.t("headers.correoElectronico"), value: 'emails', align: 'center', sortable: false },
    ...
    methods: {
        ...
        async llenar_consulta(cliente) {
            ...
            if (data.data.list.length < take) this.buscarClientes = false
            this.totalFacturas += parseInt(data.data.list.length)
