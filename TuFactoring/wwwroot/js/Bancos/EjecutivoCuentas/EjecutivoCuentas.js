    ...
    methods: {
        ...
        async detallesProspecto(datos) {
            ...
            this.listaCurrencies.map(monedas => {
                ...
                if (monedas.iso_4217 == datos.abbreviation) this.limiteCliente.currency = monedas.id;
            })
        ...
        async enviarDatos(montoLimite) {
            ...
            this.currencies.map(moneda => {
                ...
                if (this.limiteCliente.currency == moneda.id) {
                    currency = moneda.iso_4217;
                }
            });
            ...
            if (data.data.includes("success:") == true) {
                ...
                else if (data.data == "Debtor not account with currency") toastr.error(i18n.t("mensajesModal.estimadoUsuario") + "<br /><br />" + i18n.t("tooltip.limiteCreditoSinCuentaMoneda") + "(" + currency + ")");
