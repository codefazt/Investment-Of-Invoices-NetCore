var app = new Vue({
    ...
    data: {
        ...
        headersAsociado: [
            ...
            //{ text: i18n.t("headers.numeroDoc"), value: 'person.documents[0].number', align: 'center' },
    ...
    methods: {
        Inicio() {
            if (this.registro != null) {
                if (this.registro.perfil != null) {
                    if (this.registro.perfil.error == "You are not authorised to perform this action") {
