var app = new Vue({
    ...
    created: function () {
        ...
        if (this.registro != null) {
            ...
            if (this.registro.dataPaises == null) {
                toastr.error(i18n.t("mensajesModal.estimadoUsuario") + "<br /><br />" + i18n.t("notConexionDetected"));
    ...
    methods: {
        ...
        rellenarCampos(registroExistente) {
            ...
            this.NotbankBlock = false;
            this.RoutingNumber = true;
            this.aunHayDatos = true;
        ...
        rellenarCamposConfirmant(registroExistente) {

            this.vaciarCamposBancosExistentes();
            ...
            this.validateReset = true;
            this.NotbankBlock = true;
            this.RoutingNumber = false;
            this.boleanoDesicionRegistro = false;
            this.registro.registrarse.company = registroExistente.registrarse.company;
            //this.registro.registrarse.category = registroExistente.registrarse.category;
            if (this.registro.registrarse.participant == "CONFIRMANT") this.registro.registrarse.routing_number = registroExistente.registrarse.routing_number;
            if (this.registro.registrarse.routing_number != null && this.registro.registrarse.routing_number != "") {
        ...
        validarNumeroRoteo() {
            ...
            if (this.dataPaises.entities != null) {
                for (let i = 0; i < this.dataPaises.allies.length; i++) {

                    if (this.dataPaises.allies[i].routing_number == this.registro.registrarse.routing_number) {
                        this.errorRoutinNumber = this.hasError;
        ...
        validarSeleccionBancaria(event) {
            ...
            if (this.registro.cuentaActual.entity == null || this.registro.cuentaActual.entity[0] == ' ' || this.registro.cuentaActual.entity == '') {
                ...
                //if (this.registro.cuentaActual.accountNumber != null && this.registro.cuentaActual.accountNumber != "") this.validarNumeroControl();
            }
        },
            ...
            if (this.registro.cuentaActual.currency == null || this.registro.cuentaActual.currency == '') {
                ...
                if (this.registro.registrarse.accounts.length != 0) {
                    ...
                    for (let i = 0; i < this.registro.registrarse.accounts.length; i++) {
                        ...
                        if (this.registro.cuentaActual.currency != null && this.registro.cuentaActual.currency != "" &&
                            (this.registro.cuentaActual.entity != null && this.registro.cuentaActual.entity != "")) {
                            this.idBanco = this.hasSuccess;
                            this.idBancoTexto = '';
                        }
                    }
        ...
        validarnumeroCuentaBanco() {
            ...
            if (this.registro.cuentaActual.accountNumber == null || this.registro.cuentaActual.accountNumber[0] == ' ' || this.registro.cuentaActual.accountNumber == '') {
                ...
                //if (this.registro.cuentaActual.entity != null && this.registro.cuentaActual.entity != "") this.validarNumeroControl();
            }

        },
        async validarNumeroControl() {

            param = {
                id: this.registro.cuentaActual.entity,
                accountNumber: this.registro.cuentaActual.accountNumber
            }

            var data = await axios.post('?handler=Account', param, { headers: { "RequestVerificationToken": $('input:hidden[name="__RequestVerificationToken"]').val() } })
                .then((respond) => {

                    console.log(respond)
                    if (respond.data != null) {
                        toastr.error(i18n.t("mensajesModal.estimadoUsuario") + "<br/>" + respond.data.errors);
                    }
        ...
        async refreshData() {
            ...
            var data = await axios.post('?handler=Refresh', null, { headers: { "RequestVerificationToken": $('input:hidden[name="__RequestVerificationToken"]').val() } })
                .then((respond) => {
        ...
        async VerificarRegistro(comprobarDoc) {
            ...
            if (data != null) {
                ...
                let ParticipantRecover = null;
                if (data.data.contratos != null) {
                    for (let i = 0; i < data.data.contratos.length; i++) {

                        if (participant == data.data.contratos[i].participant) ParticipantRecover = data.data.contratos[i].participant;
                        if ((participant == data.data.contratos[i].participant && data.data.contacts != null) || "BACKOFFICE" == data.data.contratos[i].participant) {
                ...
                if (this.errorDocumento != this.hasError) {
                    ...
                    if (data.data.contacts == null && data.data.registro.discriminator == "LEGAL") {
                        this.registro.registrarse = data.data.registro;
                        this.registro.registrarse.participant = participant;
                        this.registro.registrarse.accounts = [];
                        this.rellenarCamposConfirmant(JSON.parse(JSON.stringify(this.registro)));

                    } else {

                        if (data.data.registro.discriminator == "PERSON") {
                            this.errorDocumento = this.hasError;
                            this.errorTextoDocumentoPrincipal = errorMensaje;
                        }
        ...
        async EnviarDatos(registro) {
            ...
            var data = await axios.post('', { person : registroGuardar, tokenReCaptcha : tokenReCaptcha}, { headers: { "RequestVerificationToken": $('input:hidden[name="__RequestVerificationToken"]').val() } })
                .then((respond) => {
                    ...
                    if (respond.data.errorValidacion != null) {
                    ...
                    else if (respond.data == 'account number already exists') {

                        toastr.error(i18n.t("mensajesModal.estimadoUsuario") + "<br /><br />" + i18n.t("tooltip.cuentaBancariaExistente"));
                    }
                    else if (respond.data == "You are not authorised to perform this action") {
                    ...
                    else if (respond.data == "invalid account number") {
                        toastr.error(i18n.t("mensajesModal.estimadoUsuario") + "<br /><br />" + i18n.t("tooltip.formatoCuentaBancaria"));
                    }
                    ...
                    else if (respond.data.includes("DisplayNumber") == true) toastr.error(i18n.t("mensajesModal.estimadoUsuario") + "<br /><br />" + i18n.t("tooltip.formatoDocumento"));
                    else if (respond.data.includes("checkAccountNumber") == true) toastr.error(i18n.t("mensajesModal.estimadoUsuario") + "<br /><br />" + i18n.t("tooltip.formatoCuentaBancaria"));
                        ...
                        else if (rgj.registrarse.participant == 'CONFIRMANT') toastr.success("<div class='text-justify'>" + i18n.t("tooltip.queridoUsuario") + "<br /><br />" + i18n.t("tooltip.registroEmpresa") + "</div>");
                        else if (rgj.registrarse.participant == 'BACKOFFICE') toastr.success("<div class='text-justify'>" + i18n.t("tooltip.queridoUsuario") + "<br /><br />" + i18n.t("tooltip.registroBanco") + "</div>");
                        else toastr.success("<div class='text-justify'>" + i18n.t("tooltip.queridoUsuario") + "<br /><br />" + i18n.t("tooltip.registroProveedor") + "</div>");
                    }
                    else {
                        toastr.error(i18n.t("mensajesModal.estimadoUsuario") + "<br /><br />" + respond.data);
                        setTimeout(function () { window.location.href = "../../index"; }, 3000); 
                    }
        ...
        habilitarbotonFormulario() {
            ...
            if (this.registro.Rol == 3 || this.registro.Rol == 4) {
                ...
                if (this.errorDocumento == this.hasSuccess &&
                    ...
                    if (this.validateReset == false || this.NotbankBlock == true) {
                        if (this.registro.registrarse.accounts.length <= 0) return true;
                    }
