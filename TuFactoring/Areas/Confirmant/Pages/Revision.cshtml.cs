...
namespace TuFactoring.Areas.Confirmant.Pages
{
    public class RevisionModel : PageModel
    {
        ...
        public async Task<JsonResult> OnPostReviewInvoice([FromBody]List<UpdateInvoice> confirming)
        {
            var token = HttpContext.Session.GetString("token");
            ...
            var confirmInvoice = await _iS.ReviewInvoice(confirming, token);
        ...
        public async Task<JsonResult> OnPostRefuseInvoice([FromBody]List<UpdateInvoice> confirming)
        {
            var token = HttpContext.Session.GetString("token");
            ...
            var confirmInvoice = await _iS.RefuseInvoice(confirming, token);
