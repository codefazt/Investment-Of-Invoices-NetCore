...
namespace TuFactoring.Areas.Identity.Pages.Account
{
    ...
    public class ResetPasswordModel : PageModel
    {
        ...
        public ResetPasswordModel(UserManager<User> userManager, IAuthService au)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            try
            {
                ...
                {
                    HttpContext.Session.Remove("userReset");
                    return RedirectToPage("/logout", "Contraseña exitosa", new { returnUrl = "~/index?exito=passwordChangeLogin" });
                }
